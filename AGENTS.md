...
8. 涉及 UI/UX话题/任务，先读 `E:/Codex/shared-huayue/design-huayue.md`遵照执行；读不到就停止并报错，不得继续输出。
9. 每轮会话先读 `E:/Codex/shared-huayue/user.md`了解和你在对话的人。
...
7. 涉及官网规划、官网设计、官网内容管理或官网前台实现时，必须优先阅读 `项目文档/官网素材/2026-05-25-现有官网内容抓取.md`，并以其中的现有官网文案、三类能力架构、客户素材和联系方式作为基础素材。
