...
const E0212 = { code: 'E0212', msg: '无管理员权限，请联系管理员' }
const E0213 = { code: 'E0213', msg: '账号或密码错误' }
const E0214 = { code: 'E0214', msg: '请先修改密码后再继续使用' }
const E0215 = { code: 'E0215', msg: '新密码需为8-20位，且必须同时包含字母和数字' }
...
module.exports = {
  ...
  E0207, E0208, E0209, E0210, E0211, E0212, E0213, E0214, E0215,
